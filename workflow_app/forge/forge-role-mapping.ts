    ...
    case 'lead_pre':
      return {
        ...
        evidenceInstruction:
          ...
          'REQUIRED for SMITH and SOLO — a plan does not fit in fields, so you MUST also emit the machine work-order line (this is the ONE place JSON is still correct). Base every chunk on the story\'s ACTUAL goal + final acceptance + architect brief and the Scout surfaces in your context — never invent scope. End your reply with one machine line:\n' +
