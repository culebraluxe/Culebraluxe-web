...
export function buildLeadRoutingDirective(context: RoutingContext): string {
  ...
  return [
    ...
    'Schema: {"version":1,"decision":"SOLO|SMITH|SPLIT|HOLD","size":"SMALL|MEDIUM|LARGE","sizeReason":"...","reason":"...","assignments":[{"id":"a","findingIds":["..."],"dependsOn":[],"evidenceRefs":["..."],"reasoning":"...","features":{"semanticSurface":1,"dependencyDepth":1,"uncertainty":1,"contextBurden":1,"proofBurden":1,"coupling":1,"changeNovelty":1,"workerFit":1},"plan":{"size":"SMALL|MEDIUM","chunks":[{"id":1,"outcome":"...","surface":["path/file.ts#symbol"],"scope":["path/file.ts#symbol"],"dependsOn":[],"invariant":"...","preconditions":[],"postconditions":"...","proof":"exact approved command"}]}}],"mergeChecks":["exact approved command"]}. `surface` is the lock field (split-handoff / smith contract). `scope` is accepted as an alias and copied onto surface. For HOLD use assignments:[] and mergeChecks:[] and explain the blocker.',
