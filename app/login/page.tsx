...
// Authentication remains a Next/Auth.js server boundary. Rust/Yew owns the
// authenticated application after /portal, but it must not replace the server
// action that starts the OAuth protocol.
