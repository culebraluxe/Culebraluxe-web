...
// ---------------------------------------------------------------------------
// CONVERTED TO RUST (screen: deals, surface Core).
//
// The route is unchanged; the screen is not. It rendered a TypeScript component with its own state
// (17 interactive hooks); it now renders the Rust screen, fed by the portal rows route.
//
...
export default function Page() {
  ...
  return (
    <div className="min-h-screen bg-background">
      <RustUiHost rowsPath="/api/portal/rust-ui/rows" start="deals" />
    </div>
  )
}
