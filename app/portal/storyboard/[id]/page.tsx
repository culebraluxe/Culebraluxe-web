...
// ---------------------------------------------------------------------------
// FLIPPED TO RUST (screen: story-record, surface Tech).
//
...
export default async function Page({ params }: { params: Promise<Record<'id', string>> }) {
  const { id } = await params

  return (
    <div className="min-h-screen bg-background">
      <RustUiHost rowsPath="/api/portal/rust-ui/rows" start="story-record" scope={id} />
    </div>
  )
}
