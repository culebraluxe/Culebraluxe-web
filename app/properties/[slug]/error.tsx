...
// DB-HARDEN-01 — route-local degradation for the public Property detail page.
// If the detail query fails (DB unavailable / schema mismatch), show a
// controlled unavailable state — this is NOT a 404 (we could not determine the
// answer, we did not determine the record is absent). Unrelated routes are
// unaffected.
    ...
    <main className="flex min-h-[70svh] items-center bg-[#f5f2ec] px-6 md:px-12">
      <div className="mx-auto w-full max-w-2xl">
        ...
        <p className="mt-6 max-w-xl text-pretty text-sm font-light leading-relaxed text-[#030f23]/60">
          We could not load this property right now. Please try again in a
          moment, or explore the current collection.
        </p>
