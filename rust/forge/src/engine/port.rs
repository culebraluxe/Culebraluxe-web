...
use workflow::{
    ApplicationCommandRequest, ApplicationCommandResult, ApplicationPort, Value, WorkflowSubject,
};
...
/// Engine-owned Forge ApplicationPort.
///
/// execute_command routes ONLY forge.*. RE commands return not_found.
/// read_facts: durable evidence ⊕ pendingEvidence (this turn wins).
