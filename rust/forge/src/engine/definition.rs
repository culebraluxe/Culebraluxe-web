...
pub fn forge_sdlc_graph() -> ProcessGraph {
    ...
    nodes.insert(
        ...
        with_position(
            node(
                ...
                "task",
                vec![
                    t("solo", "lead_implement"),
                    t("smith", "smith"),
                    t("split", "split_dispatch"),
                    t("hold", "hold"),
                ],
            ),
            "lead",
    ...
    nodes.insert(
        "split_dispatch".into(),
        NodeDefinition {
            id: "split_dispatch".into(),
            node_type: "dynamic-fork".into(),
            name: Some("split_dispatch".into()),
            plan_variable: Some("smithPlan".into()),
            branch_node: Some("smith".into()),
            join: Some("lead_post".into()),
            transitions: Some(vec![t("join", "lead_post")]),
            ..Default::default()
        },
    );
    nodes.insert(
    ...
    nodes.insert(
        ...
        with_position(
            node(
                ...
                "task",
                vec![
                    t("pass", "publish_candidate"),
                    t("fail", "repair_smith"),
                    t("replan", "repair_architect"),
                    t("hold", "hold"),
                ],
            ),
            "qa",
    ...
    nodes.insert(
        "publish_candidate".into(),
        with_position(publish, "dev_ops"),
    );
    nodes.insert(
        "hold".into(),
        with_position(
    ...
    nodes.insert(
        ...
        end("archive_research", ProcessOutcome::Completed),
    );
...
pub fn forge_sdlc_compact_definition() -> ProcessDefinition {
    ProcessDefinition {
        id: "forge-sdlc-compact".into(),
        tenant_id: None,
        key: FORGE_SDLC_KEY.into(),
