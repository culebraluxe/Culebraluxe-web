...
import type { CommsMomentRecord, CommsRepository, CommsSourceRecord } from '@/legacy/services/comms/repository'
import {
  COMMS_MAX_PAGE_SIZE,
  COMMS_MOMENT_LIMIT,
  COMMS_OPERATIONS,
  ...
  type CommsSourceDto,
} from '@/legacy/services/comms/types'
 ...
 *
 * The screen used to assemble this itself from `legacy/db/clients.ts` and
 * `legacy/db/contact-history.ts`, which is why the channel vocabulary lived in three
