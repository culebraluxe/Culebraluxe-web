...
import type { LeadAssignment, LeadProposal } from '@/legacy/workflow_app/forge/forge-lead-routing'
...
import { validateSmithContract } from '@/legacy/workflow_app/forge/smith-contract'
