...
import { proposalValidShape } from '@/legacy/workflow_app/forge/forge-lead-routing'
import { DEFAULT_FORGE_TEAM } from '@/agent-runtime/team'
import { parseLeadRouting, reviewLeadProposal, type LeadProposal, type RoutingContext } from '@/legacy/workflow_app/forge/forge-lead-routing'
import type { ForgeGateEvidence } from '@/legacy/workflow_app/forge/forge-facts'
import { architectContractFromNotes } from '@/legacy/workflow_app/forge/forge-architect-contract'
import { acceptanceClauses, buildAcceptanceMap, type AcceptanceMap } from '@/legacy/workflow_app/forge/agents/qa/types'
