...
import { parseProcessDefinitionXml, type ParsedProcessDefinition } from '@/legacy/workflow_app/xml'
import { validateParsedDefinition } from '@/legacy/workflow_app/definitions/validate-definition'
