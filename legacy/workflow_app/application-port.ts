...
import { toCommandEnvelope, toApplicationCommandResult } from '@/legacy/workflow_app/engine-bridge'
import { routeCommand } from '@/legacy/workflow_app/command-router'
import { getDealWorkflowFacts } from '@/legacy/workflow_app/facts'
import {
  getContractWorkflowFacts,
  resolveLegacyDealIdForContract,
} from '@/legacy/workflow_app/contract-facts'
