...
import { ArchitectAgent } from '@/legacy/workflow_app/forge/agents/role-agents'
import {
...
import { existsOnGitBaseRef } from '@/legacy/workflow_app/forge/agents/architect/exists-git'
import { buildArchitectDirective } from '@/legacy/workflow_app/forge/forge-architect-directive'
import { MAX_SEAMS_PER_FINDING } from '@/legacy/workflow_app/forge/forge-shaping'
...
const REAL_FILE = 'legacy/workflow_app/forge/agents/role-agents.ts'
const REAL_DIR = 'legacy/workflow_app/forge/agents'
const INVENTED_FILE = 'legacy/workflow_app/forge/agents/this-file-does-not-exist.ts'
...
test('the legacy FORGE_FINDINGS_JSON reply still passes (the fallback is not broken)', () => {
  ...
  const raw =
    ...
    '"seams":["legacy/workflow_app/forge/agents/role-agents.ts"],"hint":"SAME_UNIT"}]'
