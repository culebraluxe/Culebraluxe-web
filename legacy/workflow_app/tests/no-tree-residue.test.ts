...
import { recordRunStart } from '@/legacy/workflow_app/forge/forge-observer/record'
...
const RECORD_WRITERS: ReadonlyArray<{ file: string; tokens: readonly string[] }> = [
  ...
  { file: 'legacy/db/forge-artifact.ts', tokens: [...PATH_TOKENS, ...NOTE_TOKENS, 'workspace'] },
  { file: 'legacy/workflow_app/forge/forge-observer/types.ts', tokens: [...PATH_TOKENS, ...NOTE_TOKENS] },
  { file: 'legacy/workflow_app/forge/forge-observer/rehydrate.ts', tokens: [...PATH_TOKENS, ...NOTE_TOKENS] },
  {
    file: 'legacy/workflow_app/forge/agent-runtime-role-runner.ts',
