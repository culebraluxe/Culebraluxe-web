...
import { createPersistentTraceSink, type TraceWrite } from '@/legacy/workflow_app/forge/forge-observer/persistent-sink'
...
const ALLOWED = 'legacy/workflow_app/forge/a.ts'
const OUTSIDE = 'legacy/workflow_app/forge/b.ts'
