...
// injected executor, which is what the repository contract requires: above `legacy/db/`, a driver value
// must never appear.
// ---------------------------------------------------------------------------
...
import { listStoryExecutionSummaries } from '@/legacy/db/storyboard'
