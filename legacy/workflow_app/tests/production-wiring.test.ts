...
import { buildAcceptanceMap } from '@/legacy/workflow_app/forge/agents/qa/types'
import type { CommandResult, StaticSlice } from '@/legacy/workflow_app/forge/agents/qa/types'
...
// High defects because it ran the scripts harness and never `legacy/workflow_app/tests`. Wiring the suite in
