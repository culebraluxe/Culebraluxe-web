...
import { getForgeRoleContract } from '@/legacy/db/forge-role-contract'
import { getForgeRolePlan } from '@/legacy/db/forge-role-plan'
import { getForgeRoleFindings, listStoryForgeFindings } from '@/legacy/db/forge-role-finding'
...
const chunkRow = (over: QueryRow = {}): QueryRow => ({
  ...
  chunk_id: 1,
  size: 'SMALL',
  surface: ['legacy/workflow_app/forge/forge-lead-routing.ts'],
      ...
      contract: [
        {
          ...
          surface_scope: ['legacy/workflow_app/forge/forge-lead-routing.ts'],
          attempt: 2,
        },
      ],
    }),
      ...
      finding: [
        {
          ...
          required: true,
          seams: ['legacy/workflow_app/forge/forge-lead-routing.ts'],
          hint: 'SAME_UNIT',
        },
      ],
    }),
