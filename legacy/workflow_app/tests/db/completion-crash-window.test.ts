...
import { FORGE_SDLC_KEY, FORGE_SDLC_VERSION, parseForgeSdlc } from '@/legacy/workflow_app/definitions/forge-sdlc'
...
import { readFinalReceipt } from '@/legacy/db/workflow-command-receipt'
...
// point of `legacy/workflow_app/tests/db/`): this file moved there on 2026-09-18 so the glob could finally mean
