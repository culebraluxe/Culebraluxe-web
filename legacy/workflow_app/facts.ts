...
import { financingApplicableFromType } from '@/legacy/workflow_app/financing'
import { appraisalApplicableFromRequired } from '@/legacy/workflow_app/appraisal'
import { lenderClearToCloseFromFact } from '@/legacy/workflow_app/lender-clearance'
import { listTransactionDocumentsByDeal } from '@/legacy/db/transaction-document'
import { deriveClosingDocumentReadiness, type PacketFacts } from '@/legacy/workflow_app/transaction-packet'
import { CULEBRA_JURISDICTION_CONFIG } from '@/legacy/workflow_app/configuration'
