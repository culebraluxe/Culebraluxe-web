import type { ForgeConvergenceExecution, NoProgressCheck } from '@/legacy/workflow_app/forge/forge-convergence'
import { checkNoProgress } from '@/legacy/workflow_app/forge/forge-convergence'
import {
  buildConvergenceEvents,
  projectStoryRunsToConvergence,
  type ForgeNodeRun,
} from '@/legacy/workflow_app/forge/forge-convergence-projector'
