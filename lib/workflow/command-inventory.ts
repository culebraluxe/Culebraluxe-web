...
export const DOMAIN_COMMANDS: DomainCommand[] = [
  ...
  },
  {
    ...
    workflowAware: true,
    idempotency: 'C',
    idempotencyNote: 'Receipt compare-and-set on actionable status; canonical interaction dedupes via (source_system, source_external_id).',
    precondition: 'Submission must be received or resolution_required; attach requires an existing person and refuses an email owned elsewhere; create refuses an already-owned email.',
  },
  {
