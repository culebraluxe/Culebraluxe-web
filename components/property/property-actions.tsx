    ...
    <div className="flex flex-col gap-2.5">
      <div className="flex flex-wrap gap-1.5">
        {tags.map((tag) => (
          <span
            key={tag}
            className="border border-brand-gold/35 bg-brand-gold/[0.08] px-2.5 py-1 text-[9px] font-medium uppercase tracking-[0.14em] text-brand-navy/80"
          >
            {tag}
          </span>
        ))}
      ...
      <div className="flex items-stretch gap-2">
        <Link
          ...
          className="inline-flex min-h-11 flex-1 items-center justify-center bg-brand-navy px-4 py-2.5 text-center text-[10px] font-medium uppercase tracking-[0.17em] text-brand-ivory shadow-sm transition-colors duration-500 hover:bg-brand-navy"
        >
