...
export function FullCalendarCandidate({
  ...
  /** Pass null when the containing workspace already names the Calendar view. */
  heading?: string | null
}) {
  ...
  return (
    <Panel compact lifted headingSize="xl" heading={heading ?? undefined} className="flex h-full min-h-0 min-w-0 flex-col">
