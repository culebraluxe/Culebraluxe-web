...
export function CatchUpTaskDetail({ task }: { task: CatchUpTask | null }) {
  if (!task) {
    return (
      <Panel compact heading="Task Detail" className="flex h-full min-h-0 flex-col">
  ...
  return (
    <Panel compact heading="Task Detail" className="flex h-full min-h-0 flex-col">
      ...
      <div className="mt-6 grid flex-1 content-start gap-4 border-t border-[var(--portal-panel-border)] pt-4 sm:grid-cols-2">
