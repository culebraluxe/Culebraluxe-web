...
- `db/migrations/021_storyboard_story.sql` is **applied to the DEV branch**
  (2026-08-21) and seeds the 41 human-authored stories. It is **not** applied
  to production.
...
- The repository tests in `workflow_app/tests/storyboard.test.ts` use an
  in-memory fake and never require a database.
