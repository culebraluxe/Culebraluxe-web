...
- generated: 2026-09-15 20:55:50Z
- commit: `b320faa` (working tree dirty) on `main`
...
- `scripts/forge-doctor.ts` **MISSING** — cited · cited by ENG-FORGE-DOCTOR-01 · last touched untracked
- `workflow_app/forge/forge-doctor-report.ts` **MISSING** — cited · cited by ENG-FORGE-DOCTOR-01 · last touched untracked
- `db/agent-work.ts` — cited · cited by ENG-FORGE-DOCTOR-01 · last touched 2026-09-15
- `db/storyboard.ts` — cited · cited by ENG-FORGE-DOCTOR-01 · last touched 2026-09-14
- `node --import tsx --test workflow_app/tests/forge-doctor-report.test.ts` **MISSING** — cited · cited by ENG-FORGE-DOCTOR-01 · last touched untracked
- `docs/agent/RUNLOG.md` — lexical · term match: agent, log, worker, builder · last touched untracked
- `docs/agent/ARCH-HANDOFF.md` — lexical · term match: story, board, row, file · last touched 2026-09-11
