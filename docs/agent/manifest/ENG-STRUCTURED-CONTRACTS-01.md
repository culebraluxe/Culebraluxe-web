...
- rows: 24 — packet, cited paths and story commits first, lexical matches after
...
- `docs/agent/packets/ENG-CONTRACT-PARSER-RETIREMENT-01.md` — commit · touched by 1 commit(s) naming ENG-STRUCTURED-CONTRACTS-01 · last touched 2026-09-15
- `docs/agent/RUNLOG.md` — lexical · term match: agent, log, worker, role · last touched untracked
- `docs/agent/WORKFLOW-ARCHITECTURE.md` — lexical · term match: forge, holds, one, every · last touched 2026-09-16
...
- `docs/agent/FORGE-WORKSHOP.md` — lexical · term match: culebraluxe, manifest, handoff, source · last touched 2026-09-18
- `docs/agent/mailbox/DEEPSEEK-2026-09-16.md` — lexical · term match: grok, 2026-09-16, worker, neon · last touched 2026-09-15
- `docs/agent/mailbox/DEEPSEEK-2026-09-16-introduction.md` — lexical · term match: 2026-09-16, forge, worker, neon · last touched 2026-09-15
